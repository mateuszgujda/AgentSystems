...
public class Simulation {
    ...
    public Simulation(Settings settings) {
        ...
        for (int i = 0; i < startingNumberOfCars; ++i) {
            ...
            highway.roads[randomRoads].road[randomRoad].lane.get(randomLane).vehicle = new Car(maxVelocity, rand.nextInt(maxVelocity), rand.nextInt(6) + 1);
